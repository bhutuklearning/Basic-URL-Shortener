...
const AnalyticsPage = () => {
  ...
  if (error) {
    return (
      <div className="max-w-4xl mx-auto p-6">
        <div className="bg-red-50 dark:bg-red-950/50 border-l-4 border-red-500 text-red-700 dark:text-red-400 p-6 rounded-lg mb-6 flex items-start">
  ...
  return (
    <div className="max-w-6xl mx-auto p-4">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8 bg-linear-to-r from-blue-600 to-indigo-700 p-6 rounded-lg shadow-lg dark:shadow-gray-900/50 text-white">
        <div>
        ...
        <button
          onClick={() => navigate("/dashboard")}
          className="mt-4 md:mt-0 bg-white dark:bg-gray-900 text-blue-700 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-gray-800 px-6 py-3 rounded-lg font-semibold flex items-center space-x-2 transition-colors shadow-md"
        >
          <FaArrowLeft className="h-4 w-4" />
          <span>Back to Dashboard</span>
        </button>
      ...
      {/* URL Info Card */}
      <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg dark:shadow-gray-900/50 p-6 mb-8 border-t-4 border-blue-600">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4 flex items-center">
          <FaLink className="mr-2 text-blue-600 dark:text-blue-400" />
          URL Information
        </h2>
        <div className="bg-blue-50 dark:bg-blue-950/50 p-4 rounded-lg mb-4 text-gray-900 dark:text-white">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div className="mb-4 md:mb-0">
              ...
              <div className="flex items-center md:overflow-hidden">
                <span className="font-mono text-blue-700 dark:text-blue-400 mr-2 md: overflow-hidden">
            ...
            <div>
              ...
              <div className="flex items-center">
                <span className="truncate max-w-md mr-2 text-gray-900 dark:text-gray-100">
          ...
          <div className="mt-4 pt-4 border-t border-blue-200 dark:border-blue-800 flex flex-col md:flex-row md:justify-between">
            <div className="mb-2 md:mb-0">
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-900 dark:text-gray-100">{formatDate(urlDetails?.createdAt || new Date())}</span>
              </div>
            </div>
            <div>
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">Short ID</p>
              <div className="flex items-center">
                <span className="font-mono bg-blue-100 dark:bg-blue-900/50 px-2 py-1 rounded text-blue-800 dark:text-blue-300">
                  {resolvedShortId || "—"}
                </span>
              </div>
            </div>
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg dark:shadow-gray-900/50 p-6 transform transition-all duration-300 hover:scale-105 hover:shadow-xl dark:hover:shadow-gray-900/50">
          <div className="flex items-center">
            <div className="bg-blue-100 dark:bg-blue-900/50 p-3 rounded-full">
              <FaMousePointer className="h-6 w-6 text-blue-600 dark:text-blue-400" />
            </div>
            <div className="ml-4">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg dark:shadow-gray-900/50 p-6 transform transition-all duration-300 hover:scale-105 hover:shadow-xl dark:hover:shadow-gray-900/50">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Traffic Sources</p>
              <p className="text-3xl font-bold text-gray-900 dark:text-white">
      ...
      {/* Click Trends Chart */}
      <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg dark:shadow-gray-900/50 p-6 mb-8">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4 flex items-center">
        ...
        <div className="h-64 flex items-end justify-between space-x-2">
          {clicksByDay.map((day, index) => (
            <div key={index} className="flex flex-col items-center flex-1">
              ...
              ></div>
              <div className="text-xs font-medium text-gray-600 dark:text-gray-400 mt-2">{day.date}</div>
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg dark:shadow-gray-900/50 overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-linear-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white flex items-center">
              <FaGlobe className="mr-2 text-blue-600 dark:text-blue-400" />
              Top Referrers
            </h2>
          </div>
          <div className="p-6">
                ...
                {topReferrers.map((referrer, index) => (
                  <div key={index} className="group">
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <span className="text-sm font-bold bg-blue-100 dark:bg-blue-900/50 text-blue-800 dark:text-blue-300 px-2 py-1 rounded-full">
                        {referrer.count} clicks
                      </span>
                    </div>
                    <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2.5 group-hover:bg-gray-300 dark:group-hover:bg-gray-600 transition-colors">
                      <div
        ...
        {/* <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg dark:shadow-gray-900/50 overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-linear-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white flex items-center">
              <FaDesktop className="mr-2 text-blue-600 dark:text-blue-400" />
              Devices & Browsers
            </h2>
          </div>
          <div className="p-6">
            <div className="grid grid-cols-2 gap-6">
              <div>
                <h3 className="text-lg font-medium text-gray-800 dark:text-gray-100 mb-3">Device Types</h3>
                <div className="space-y-4">
                  <div>
                    <div className="flex items-center justify-between mb-1">
              ...
              <div>
                <h3 className="text-lg font-medium text-gray-800 dark:text-gray-100 mb-3">Top Browsers</h3>
                <div className="space-y-4">
                  <div>
                    <div className="flex items-center justify-between mb-1">
            ...
            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              ...
              <tbody className="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
                {safeAnalytics.details.map((click, index) => (
                  <tr key={index} className="hover:bg-blue-50 dark:hover:bg-blue-950/30 transition-colors">
