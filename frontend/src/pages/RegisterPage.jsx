...
const RegisterPage = () => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-50 via-purple-50 to-indigo-100 dark:bg-gray-950 dark:from-gray-950 dark:via-purple-950 dark:to-indigo-950 flex items-center justify-center px-4 py-8 relative text-gray-900 dark:text-white">
      {/* Theme Toggle */}
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-4 border-2 border-gray-200 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200 bg-gray-50 dark:bg-gray-800 focus:bg-white dark:focus:bg-gray-800 dark:text-white dark:placeholder-gray-500"
                    placeholder="johndoe"
                    required
                  />
                </div>
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full pl-12 pr-14 py-4 border-2 border-gray-200 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200 bg-gray-50 dark:bg-gray-800 focus:bg-white dark:focus:bg-gray-800 dark:text-white dark:placeholder-gray-500"
                    placeholder="••••••••"
                    required
                  />
                  <button
            ...
            <div className="mt-8 space-y-4">
              <div className="text-center">
                <p className="text-xs text-gray-500 leading-relaxed">
                  ...
                  <Link to="#" className="text-purple-600 dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-400 font-medium">
                    Terms of Service
                  </Link>{" "}
                  and{" "}
                  <Link to="#" className="text-purple-600 dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-400 font-medium">
              ...
              <div className="text-center">
                <p className="text-gray-600 dark:text-gray-400 text-sm">
                  ...
                  <Link
                    to="/login"
                    className="text-purple-600 dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-400 font-semibold transition-colors duration-200"
                  >
                    Sign in here
                  </Link>
                </p>
